defmodule LiveViewStudio.Servers.Server do
  ...
  def changeset(server, attrs) do
    # server
    # |> cast(attrs, [:deploy_count, :framework, :git_repo, :last_commit_id, :last_commit_message, :name, :size, :size, :status])
    # |> validate_required([:deploy_count, :framework, :git_repo, :last_commit_id, :last_commit_message, :name, :size, :size, :status])
    server
